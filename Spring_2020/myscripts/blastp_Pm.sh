...
# (-query) to the already formatted Patiria miniata protein database (-db).
...
blastp -query /data/project_data/assembly/08-11-35-36_cl20_longest_orfs_gene.pep \
       -db /data/project_data/assembly/database/Pm_proteins.fasta \
       -out /data/project_data/assembly/blast/blastp_vs_Pminiata.outfmt6 \
       -outfmt 6 \
       -num_threads 2 \
       -max_target_seqs 1
