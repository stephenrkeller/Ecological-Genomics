...
MyLeftReads=`find . -maxdepth 1 -name "2*_R1*.fq.gz"`
...
do
    ...
    then
        ...
        echo $myShort
        bwa aln -t 4 /data/project_data/assembly/08-11-35-36_cl20_longest_orfs_gene.cds $myLeft > /data/project_data/sam/$myLeft".sai" 
        bwa aln -t 4 /data/project_data/assembly/08-11-35-36_cl20_longest_orfs_gene.cds $myRight > /data/project_data/sam/$myRight".sai" 
