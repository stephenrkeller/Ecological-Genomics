...
- For the first part of the semester, we're going to analyze some unpublished exome-capture Illumina data sequenced from red spruce trees.  For this project, my lab collected needle tissue and cones from trees across the Appalachian mountains, from Tennessee, USA to New Brunswick, Canada. ![](https://github.com/stephenrkeller/Ecological_Genomics/blob/master/Spring_2020/mydata/metadata/Figure2_Capblancq_etal_EvolApps.pdf)  
